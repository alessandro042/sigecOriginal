            ...
            <div class="card shadow-sm border-0">
                ...
                <div class="card-body p-5">
                    <div class="mb-4 text-center">
                        ...
                        <a href="{{ route('matricula.igualdad-genero.generate.excel') }}" class="btn btn-lg btn-secondary text-white shadow-sm">
                            <i class="fas fa-file-download"></i> Descargar Plantilla Excel
                        </a>
                    </div>

                    <form action="{{ route('matricula.igualdad-genero.import') }}" method="POST" enctype="multipart/form-data">
                        @csrf
